  ...
  return (
    <div style={{ minHeight: '100vh', background: bg, padding: '20px 14px 40px', boxSizing: 'border-box' as const }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 18 }}>
        <h1 style={{ fontSize: 18, fontWeight: 900, color: navy, margin: 0 }}>
          🏆 Figurinha da Copa 2026
        </h1>
      </div>

      <div style={{ maxWidth: 430, margin: '0 auto', textAlign: 'center', boxSizing: 'border-box' as const }}>

        <div style={{ fontSize: 40, fontWeight: 900, color: navy, fontStyle: 'italic', letterSpacing: -1, lineHeight: 1, marginBottom: 6 }}>
          GOOLL! 🎉
        </div>
        <h2 style={{ fontSize: 17, fontWeight: 700, color: navy, marginBottom: 8 }}>
        ...
        <div style={{ background: 'white', borderRadius: 20, padding: '20px 16px', marginBottom: 14, boxShadow: '0 4px 20px rgba(0,0,0,0.10)', boxSizing: 'border-box' as const }}>
          ...
          <div style={{ fontSize: 40, fontWeight: 900, color: green, lineHeight: 1, marginBottom: 6 }}>
            R$12,90
          </div>
          ...
          <div style={{ color: green, fontWeight: 800, fontSize: 13, marginBottom: 8 }}>
        ...
        {/* Selos */}
        <div style={{ display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap' as const, fontSize: 12, color: navy, fontWeight: 700 }}>
